...
function ProgressRail({
  ...
  return (
    <div className="sp-rail">
      <button className="sp-rail-back" onClick={() => onJump(-1)}>
        ←
      </button>
        ...
        {book.imageUrl ? (
          ...
          <div className="sp-cover-placeholder">
            ...
            <div className="sp-cover-content">
              <span className="sp-cover-eyebrow">
                {BOOK_CATEGORIES[book.category]}
              </span>
              <h2 className="sp-cover-title-gu">
                {book.titleGu || book.title}
              </h2>
              <p className="sp-cover-title-en">
                {book.titleGu ? book.title : ""}
              </p>
...
function BookSpine({
  ...
  const { dark } = useTheme();
  const accent = book.themeColor || CATEGORY_COLORS[book.category] || "#c5a55a";
  const bg = dark ? BG_COLORS[book.category] || "#1a1a1a" : "#ffffff";
        ...
        {book.imageUrl ? (
          ...
          <div
            ...
            style={
              {
                "--sp-accent":
                  book.themeColor || CATEGORY_COLORS[book.category],
...
function DetailSection({
  ...
  return (
    ...
    >
      <div className="sp-detail-hero">
        ...
        <div className="sp-detail-info">
          ...
          >
            ...
            {book.titleGu && (
              <div className="sp-detail-titlegu">{book.titleGu}</div>
            )}
            ...
            <div className="sp-detail-specs">
              {book.isbn && (
                <div className="sp-spec">
                  <span className="sp-spec-label">ISBN</span>
                  <span>{book.isbn}</span>
                </div>
              )}
              {book.pages && (
                <div className="sp-spec">
                  <span className="sp-spec-label">Pages</span>
                  <span>{book.pages}</span>
                </div>
              )}
              {book.year && (
                <div className="sp-spec">
                  <span className="sp-spec-label">Year</span>
                  <span>{book.year}</span>
                </div>
              )}
              {book.publisher && (
                <div className="sp-spec">
                  <span className="sp-spec-label">Publisher</span>
      ...
      <div className="sp-detail-endorsements">
        ...
        >
          <p className="sp-endorsement-text">
            Dr. Khachar is the preeminent historian of the Kathiawar peninsula.
            His work on the 222 princely states is a masterpiece of archival
            detective work.
          </p>
        ...
        >
          <p className="sp-endorsement-text">
            A monumental contribution to the historiography of Western India.
            Dr. Khachar's research methodology sets a gold standard for regional
            historians.
          </p>
          <div className="sp-endorsement-author">
        ...
        >
          <p className="sp-endorsement-text">
            The Library of Congress recognition is well-deserved. These works
            preserve the living memory of Saurashtra's 222 princely states for
            future generations.
          </p>
          <div className="sp-endorsement-author">
      ...
      {/* Zine / Preview Download Section */}
      <motion.div
        className="sp-zine-section"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
      >
        <div className="sp-zine-inner">
          <div className="sp-zine-header">
            <div className="sp-zine-label">Free Resources</div>
            <div className="sp-zine-title">Preview & Archive Materials</div>
            <div className="sp-zine-desc">
              Browse selected pages and archival visuals from this volume.
            </div>
          </div>
          <div className="sp-zine-grid">
            <button
              className="sp-zine-card"
              onClick={() => {
                setPreviewBook({
                  title: book.title,
                  pages: [
            ...
            >
              <span className="sp-zine-icon">📖</span>
              <div className="sp-zine-info">
                <span className="sp-zine-info-name">Archive Preview</span>
                <span className="sp-zine-info-meta">Visuals & Manuscripts</span>
              </div>
            </button>
            <button
              className="sp-zine-card"
            ...
            >
              <span className="sp-zine-icon">📑</span>
              <div className="sp-zine-info">
                <span className="sp-zine-info-name">Sample Pages</span>
                <span className="sp-zine-info-meta">Selected Excerpts</span>
              </div>
            </button>
            <a href="mailto:pkhachar@gmail.com" className="sp-zine-card">
              <span className="sp-zine-icon">✉️</span>
              <div className="sp-zine-info">
                <span className="sp-zine-info-name">Request Copy</span>
                <span className="sp-zine-info-meta">Contact Author</span>
              </div>
            </a>
          </div>
        </div>
      ...
      <div className="sp-author-section">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="sp-author-label">About the Author</div>
          <h3 className="sp-author-name">Dr. Praduman Khachar</h3>
          <p className="sp-author-bio">
            Associate Professor & PhD Guide at Dr. Subhash Mahila Arts, Comm. &
            Home Science College, Junagadh. Convener of INTACH Junagadh Chapter.
            Over three decades of meticulous research into Saurashtra and
            Gujarat's history, with 33 books published and 23 works selected by
          ...
          <div className="sp-author-stats">
            ...
            <div className="sp-author-stat">
              ...
              <span className="sp-author-stat-label">
                In Library of Congress
              </span>
            </div>
            <div className="sp-author-stat">
              <span className="sp-author-stat-num">30+</span>
              <span className="sp-author-stat-label">Years of Research</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <section className="sp-hero-editorial">
        ...
        >
          ...
          <h1 className="sp-hero-title">
            33 Books on History, Heritage & Culture
          </h1>
          <div className="sp-hero-divider" />
          <p className="sp-hero-subtitle">
            Over three decades of meticulous research into Saurashtra and
            Gujarat's history — 23 works selected by the Library of Congress,
            USA.
          </p>
        </motion.div>
      </section>
                ...
                {filtered.map((book, i) => (
                  <tr key={book.title} onClick={() => setSelectedIdx(i)}>
                    <td>
                      ...
                      {book.titleGu && (
                        <div className="sp-table-titlegu">{book.titleGu}</div>
                      )}
                    </td>
