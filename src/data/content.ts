...
export const BOOKS: Book[] = [
  { title: "Bahauddin College: Ek Aitihasik Adhyayan", titleGu: "બહાઉદ્દીન કોલેજ", year: "2017", category: "institutional", locSelected: true },
  { title: "Itihas Etale Dr. Khachar", titleGu: "ઈતિહાસ એટલે ડૉ. ખાચર", category: "history", locSelected: true },
  { title: "Bhuchar Mori Ni Ladai", titleGu: "ભૂચર મોરીની લડાઈ", category: "battles", locSelected: true },
  { title: "Itihas No Aaradhak", titleGu: "ઈતિહાસનો આરાધક", category: "history", locSelected: true },
  { title: "Kathio Ane Kathiyavad (Vol. 3)", titleGu: "કાઠીઓ અને કાઠિયાવાડ – ભા. ૩", category: "kathi", locSelected: true },
  { title: "Kathio Ane Kathiyavad (Vol. 9)", titleGu: "કાઠીઓ અને કાઠિયાવાડ – ભા. ૯", category: "kathi", locSelected: true },
  { title: "Grantho Ane Shilalekho", titleGu: "ગ્રંથો અને શિલાલેખો", category: "epigraphy", locSelected: true },
  { title: "Girnar No Itihas", titleGu: "ગિરનારનો ઈતિહાસ", category: "history", locSelected: true },
  { title: "Kathiyavad Na Rajvio", titleGu: "કાઠિયાવાડના રાજવીઓ", category: "royals", locSelected: true },
  { title: "Kathiyavad Na Kathi Rajvada", titleGu: "કાઠિયાવાડના કાઠી રાજવાડા", category: "kathi", locSelected: true },
  { title: "Kathi Itihas Ane Sanskriti", titleGu: "કાઠી ઈતિહાસ અને સંસ્કૃતિ", category: "kathi", locSelected: true },
  { title: "Kathi Darbargadho", titleGu: "કાઠી દરબારગઢો", category: "kathi", locSelected: true },
  { title: "Kathi Darbaroni Vato", titleGu: "કાઠી દરબારોની વાતો", category: "kathi", locSelected: true },
  { title: "Kathio Na Anya Rajyo Sathe Sambandho", titleGu: "કાઠીઓના અન્ય રાજ્યો સાથે સંબંધો", category: "kathi", locSelected: true },
  { title: "Kathio Nu Sanskrutik Pradan", titleGu: "કાઠીઓનું સાંસ્કૃતિક પ્રદાન", category: "kathi", locSelected: true },
  { title: "Kathio Ma Pratham Kon", titleGu: "કાઠીઓમાં પ્રથમ કોણ", category: "kathi", locSelected: true },
  { title: "Sorath Sarkar", titleGu: "સોરઠ સરકાર", category: "governance", locSelected: true },
  { title: "Itihas Manjusha (Lekh Sangrah)", titleGu: "ઈતિહાસ મંજૂષા (લેખ સંગ્રહ)", category: "essays", locSelected: true },
  { title: "Itihas Varidhi", titleGu: "ઈતિહાસ વારિધિ", category: "history", locSelected: true },
  { title: "Itihas Ni Ajani Vato", titleGu: "ઈતિહાસની અજાણી વાતો", category: "history", locSelected: true },
  { title: "Babi Rajvansh Na Gito", titleGu: "બાબી રાજવંશના ગીતો", category: "heritage", locSelected: true },
  { title: "Bhule Bisre Aaine", titleGu: "ભૂલે બિસરે આઈને", category: "history", locSelected: true },
  { title: "Shashko Ni Vanshavalio", titleGu: "શાસકોની વંશાવળીઓ", category: "genealogy", locSelected: true },
