...
export const SITE: SITE_INFO = {
  ...
  institution:
    "Dr. Subhash Mahila Arts, Comm. & Home Science College, Junagadh",
  tagline:
    "Preserving the legacy of Saurashtra through scholarly research and storytelling.",
};
    ...
    recentPosts: [
      {
        ...
        preview: "https://picsum.photos/300/300?random=11",
      },
      {
        id: "2",
        type: "video",
        url: "https://instagram.com",
        preview: "https://picsum.photos/300/300?random=12",
      },
      {
        id: "3",
        type: "photo",
        url: "https://instagram.com",
        preview: "https://picsum.photos/300/300?random=13",
      },
    ],
  },
  facebook: {
    ...
    recentPosts: [
      {
        id: "1",
        text: "New lecture series on the history of Saurashtra is now live.",
        date: "2 days ago",
      },
      {
        id: "2",
        text: "Discussing the architecture of the Palitana temples.",
        date: "1 week ago",
      },
    ],
  },
...
export const BOOKS: Book[] = [
  ...
  },
  {
    ...
    pages: 185,
    description:
      "A detailed military and historical analysis of the Battle of Bhuchar Mori (1591), one of the most significant conflicts in Saurashtra's history.",
    themeColor: "#7a6a5a",
  ...
  },
  {
    ...
    pages: 250,
    description:
      "A collection of research articles on various aspects of Gujarat's regional history, published by the Gujarat Sahitya Akademi.",
  ...
  },
  {
    ...
    pages: 340,
    description:
      "The historical legacy and academic impact of Bahauddin College, Junagadh. A comprehensive institutional history spanning decades.",
  ...
  },
  {
    ...
    price: "₹150",
    description:
      "An accessible exploration of what history means and its relevance to contemporary society.",
  ...
  },
  {
    ...
    price: "₹11",
    description:
      "A study of ancient manuscripts and inscriptions from the Saurashtra region, documenting historical texts and their significance.",
  ...
  },
  {
    ...
    price: "Out of print",
    description:
      "Rediscovering forgotten historical narratives and cultural heritage of the Saurashtra region.",
  ...
  },
  {
    ...
    price: "₹90",
    description:
      "A collection of essays on historical themes, published by the Gujarat Sahitya Akademi.",
  ...
  },
  {
    ...
    price: "₹56",
    description:
      "Genealogical records of rulers of Saurashtra and Gujarat, documenting royal lineages and succession.",
  ...
  },
  {
    ...
    price: "₹500",
    description:
      "Gujarati translation/edition of Colonel Watson's comprehensive work on Kathiawad, a foundational historical text.",
  ...
  },
  {
    ...
    price: "Out of print",
    description:
      "A study of the royals of Kathiawad, covering the princely states and their rulers.",
  ...
  },
  {
    ...
    price: "Out of print",
    description:
      "The contribution of Kathi royals to the Swaminarayan tradition, documenting their patronage and involvement.",
  ...
  },
  {
    ...
    price: "₹400",
    description:
      "Dr. Khachar's PhD thesis — 'The Kathis and Kathiawad.' The foundational academic work on Kathi history and culture.",
  ...
  },
  {
    ...
    price: "₹40",
    description:
      "Songs of the Babi royal dynasty, preserving the musical and cultural heritage of the Babi rulers.",
  ...
  },
  {
    ...
    price: "₹70",
    description:
      "A collection of historical essays published by the Gujarat Sahitya Akademi.",
  ...
  },
  {
    ...
    price: "—",
    description:
      "A centenary tribute biography of Dr. Shambhuprasad Desai, documenting his contributions to scholarship.",
  ...
  },
  {
    ...
    price: "₹300",
    description:
      "The history of Mount Girnar, one of the most sacred and historically significant mountains in Gujarat.",
    imageUrl: "/books/covers/girnar-no-itihas.jpg",
    purchaseLinks: [
      {
        store: "GujaratBookshelf",
        url: "https://gujaratbookshelf.com",
        price: "₹540",
      },
    ],
  },
  {
    ...
    price: "Out of print",
    description:
      "The glorious history of Saurashtra, covering major historical events and figures.",
  ...
  },
  {
    ...
    pages: 280,
    description:
      "A pictorial history of ancient and modern Junagadh. Co-authored with Dr. Dhirubhai Vala. Features 4 B/W illustrations.",
    ...
    purchaseLinks: [
      ...
      {
        store: "Exotic India Art",
        url: "https://exoticindiaart.com",
        price: "$44",
      },
    ],
  },
  {
    ...
    price: "₹200",
    description:
      "Governance of the Sorath State under Nawab Mahabat Khanji, documenting administrative history.",
  ...
  },
  {
    ...
    price: "₹56",
    description:
      "Introduction to historical research methodology, a guide for aspiring historians.",
  ...
  },
  {
    ...
    price: "Priceless",
    description:
      "Temples of Girnar and Gir region, documenting the architectural heritage of the area.",
  ...
  },
  {
    ...
    price: "Out of print",
    description:
      "Unknown facts and stories from history, revealing hidden narratives of the past.",
  ...
  },
  {
    ...
    price: "₹70",
    description:
      "Ocean of History — a collection of historical essays covering diverse topics.",
  ...
  },
  {
    ...
    price: "₹120",
    description:
      "Revised and enlarged edition of the 2006 work on Kathi contributions to the Swaminarayan tradition.",
  ...
  },
  {
    ...
    price: "₹150",
    description:
      "Gujarati translation of Colonel Watson's 'History of Kathi', a foundational text on Kathi history.",
  ...
  },
  {
    ...
    price: "₹200",
    description:
      "English translation/edition of Colonel Watson's 'History of Kathi', making this work accessible to English readers.",
  ...
  },
  {
    ...
    price: "₹160",
    description:
      "Famous royals of Saurashtra, documenting the lives and legacies of prominent rulers.",
  ...
  },
  {
    ...
    price: "Priceless",
    description:
      "Historical places of Gir Somnath district, a comprehensive guide to the region's heritage sites.",
  ...
  },
  {
    ...
    asin: "B098M7HMYC",
    description:
      "99 stories covering love stories, valor tales, saint stories, historical narratives, and sacrifice tales of Kathiawad.",
    imageUrl: "/books/covers/kathiyavad-ni-rasdhar.jpg",
    purchaseLinks: [
      {
        store: "Amazon.in",
        url: "https://www.amazon.in/dp/B098M7HMYC",
        price: "₹455",
      },
      {
        store: "GujaratBookshelf",
  ...
  },
  {
    ...
    price: "₹844",
    description:
      "History of the Sorath and Barda regions, documenting the historical development of these areas.",
  ...
  },
  {
    ...
    price: "₹1,400",
    description:
      "From the Attic of History — uncovering hidden historical narratives and forgotten stories.",
...
export const PLAYLISTS: Playlist[] = [
  {
    title: "જૂનાગઢ રાજ્ય",
    titleEn: "Junagadh State",
    count: 43,
    emoji: "🏰",
    category: "states",
  },
  {
    title: "ભાવનગર રાજ્ય સંગ્રહ",
    titleEn: "Bhavnagar State Archives",
    count: 59,
    emoji: "📜",
    category: "states",
  },
  ...
  {
    title: "પોરબંદર રાજ્ય — જેઠવા સ્ટેટ",
    titleEn: "Porbandar – Jethva State",
    count: 12,
    emoji: "🌊",
    category: "states",
  },
  ...
  {
    title: "માળાવ‌દ‌ર સ્ટેટ",
    titleEn: "Manavadar State",
    count: 7,
    emoji: "🏛️",
    category: "states",
  },
  ...
  {
    title: "યુગ યુગીન સોમનાથ",
    titleEn: "Yug Yugin Somnath",
    count: 14,
    emoji: "🕉️",
    category: "heritage",
  },
  {
    title: "ધર્મ સ્થાનો",
    titleEn: "Dharm Sthano (Religion)",
    count: 21,
    emoji: "🙏",
    category: "heritage",
  },
  {
    title: "જડેશ્વર મહાદેવ",
    titleEn: "Jadeshwar Mahadev",
    count: 27,
    emoji: "📿",
    category: "heritage",
  },
  {
    title: "ભારતનો સ્વતંત્ર સંગ્રામ",
  ...
  {
    title: "મહા ગુજરાત આંદોલન",
    titleEn: "Maha Gujarat Aandolan",
    count: 2,
    emoji: "✊",
    category: "freedom",
  },
  ...
  {
    title: "ગામ નામનો ઈતિહાસ",
    titleEn: "Village Histories",
    count: 14,
    emoji: "🏡",
    category: "regional",
  },
  {
    title: "૧૨૫ વર્ષ પહેલાનું રાજકોટ",
    titleEn: "125 Varsh Pahelanu Rajkot",
    count: 87,
    emoji: "🏙️",
    category: "regional",
  },
  {
    title: "ઐતિહાસિક કડિયો",
    titleEn: "Historical Anecdotes",
    count: 10,
    emoji: "📖",
    category: "regional",
  },
  {
    title: "વાર રામવડા - વાવડા",
    titleEn: "Vaar Ramvada - Vavda",
    count: 6,
    emoji: "🎶",
    category: "regional",
  },
  {
    title: "ઇતિહાસ ના મૌખિક સ્ત્રોતો",
    titleEn: "Oral Sources of History",
    count: 16,
    emoji: "🔬",
    category: "academic",
  },
  {
    title: "પી.એચ.ડી. માર્ગદર્શન",
    titleEn: "Ph.D. Guidance",
    count: 12,
    emoji: "🎓",
    category: "academic",
  },
  ...
  {
    title: "ઇતિહાસ નો પરિચય",
    titleEn: "Introduction to History",
    count: 6,
    emoji: "🧑‍🏫",
    category: "academic",
  },
  {
    title: "લોકકલાની વાતો - મુંબઈ સમાચાર",
    titleEn: "Folk Arts - Mumbai Samachar",
    count: 31,
    emoji: "🎨",
    category: "folk",
  },
  {
    title: "મુલાકાત - પ્રદ્યુમ્ન ખાચર",
    titleEn: "Interview - Praduman Khachar",
    count: 7,
    emoji: "🎤",
    category: "folk",
  },
  {
    title: "મામા અને કોરોના",
    titleEn: "Mama and Corona",
    count: 4,
    emoji: "🦠",
    category: "folk",
  },
  ...
  {
    title: "કંડા ભૂલ્યા",
    titleEn: "Major Historical Series",
    count: 38,
    emoji: "🗺️",
    category: "special",
  },
  {
    title: "સરદાર પટેલનું જામનગર પ્રવચન",
    titleEn: "Sardar Patel's Jamnagar Speech",
    count: 9,
    emoji: "🎙️",
    category: "special",
  },
...
export const STATS: StatItem[] = [
  ...
  { number: "11", label: "Disputes & Legal Battles" },
];
...
export const EDUCATION: EducationItem[] = [
  {
    ...
    university: "M. K. University, Bhavnagar",
    year: "2006",
    grade: "Pass",
  },
  {
...
export const CAREER: CareerItem[] = [
  {
    period: "1992 – Present",
    title: "Associate Professor (U.G. Level)",
    place: "Dr. Subhash Mahila Arts, Comm. & H. Sc. College, Junagadh",
    desc: "33 Years of teaching at undergraduate level",
  },
  {
    period: "1998 – 2006",
    title: "P.G. Lecturer",
    place: "Bahauddin College, Junagadh (Run by Government of Gujarat)",
    desc: "8 Years of postgraduate level teaching",
  },
  {
    period: "2010 – Present",
    title: "Convener",
    place: "INTACH Junagadh Chapter",
  ...
  },
  {
    ...
    place: "University Grant Commission, Pune",
    desc: "Funded research project completed in 1 year",
  },
];
...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    icon: "🏆",
    text: "Recipient of **Kalatirth Surat Sanskruti Savardhan Award 2025**",
  },
  {
    icon: "❤️",
    text: "Dedicated Personality Award from **International Human Rights Association**",
  },
  {
    icon: "📜",
    text: "**23 Books** selected by **Library of Congress, USA** out of 33 total publications",
  },
  {
    icon: "⚖️",
    text: "Books found useful in **11 different types of disputes and legal battles** in courts, government offices & sarkari kacheris (સરકારી કચેરીઓ) of Gujarat",
  },
  {
    icon: "🎓",
    text: "A Prolific author of **33 high quality books** and **15 Research Articles**",
  },
  {
    icon: "🎙️",
    text: "Called **12 times** for Radio Vartalap Karyakram and **6 times** in Doordarshan Program",
  },
  {
    icon: "🎤",
    text: "Delivered Guest/Expert Lectures as **Keynote Speaker** across India **25 times**",
  },
  {
    icon: "✍️",
    text: "Written historical Articles in **Mumbai Samachar** for 2 years & **Fulchhab** for 3 years",
  },
  {
    icon: "📺",
    text: "Uploaded **485 historical videos** on YouTube for creating awareness, still active",
  },
  {
    icon: "📚",
    text: "Author of **Adhikarn** of well-known Gujarati Encyclopedia, Consultant of various Telefilms",
  },
  {
    icon: "🖌️",
    text: "Organized **Exhibition** of historical pictures in different cities of Gujarat state",
  },
];
